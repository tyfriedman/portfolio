export const DEFAULT_TASKS: string[] = [
  "Flip a waterbottle in RJ's room.",
  "Leave a poker chip on Fitz's sink.",
  "Make a pong shot in the front room.",
  "Bring a spoon from Jordan's room to RJ's room.",
  "Open/close all of the shades in Derek's room.",
