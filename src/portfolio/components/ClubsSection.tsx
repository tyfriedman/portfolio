const ClubsSection = () => {
  return (
    <section id="clubs" className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-800 mb-8 sm:mb-12 md:mb-16">Clubs & Organizations</h2>
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 sm:p-6 border border-blue-200">
            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-3">Data Club of Notre Dame</h3>
            <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">President | January 2024 – Present</p>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 sm:p-6 border border-green-200">
            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-3">CS4Good</h3>
            <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">Director of Projects | August 2024 – Present</p>
            <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
